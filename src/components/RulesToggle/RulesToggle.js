...
render() {
  return (
      <div>
        ...
        {this.state.visible
         && <div className="rules-div"><h6>A random mushroom will be selected when you click the button above. There are 15 normal mushrooms, 3 poisonous, and 1 deadly.</h6>
